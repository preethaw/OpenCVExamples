...
img1 = cv2.imread('images/retina1.jpeg', 0)
img2 = cv2.imread('images/retina_shifted_down.jpeg', 0)
...
print len(matchesMask)
# Draw the matches
drawParameters = dict(matchColor=(255, 0, 0), singlePointColor=None, matchesMask=matchesMask, flags=2)
